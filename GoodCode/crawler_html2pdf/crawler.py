...
class Crawler(object):
    ...
    def parse_menu(self, reponse):
        """
        解析目录结构，获取所有URL目录列表：由子类实现
        :param reponse: 爬虫返回的response对象
        :return: url可迭代对象(iterable)列表，生成器，元祖都可以
        """
